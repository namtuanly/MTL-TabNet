...
alphabet_file = '/disks/vaskar/nam/data/mmocr_wikitabnet_ja_full_border_v2_train/structure_alphabet.txt'
alphabet_len = len(open(alphabet_file, 'r').readlines())
max_seq_len = 500

cell_alphabet_file = '/disks/vaskar/nam/data/mmocr_wikitabnet_ja_full_border_v2_train/textline_recognition_alphabet.txt'
...
train_img_prefix = '/disks/strg16-176/nam/data/html_ja_tables/wiki_jp_tables_full_border_v2/train/'
train_anno_file1 = '/home2/nam/nam_data/data/mmocr_wikitabnet_ja_full_border_v2_train/StructureLabelAddEmptyBbox_train/'
train1 = dict(
    type=dataset_type,
...
valid_img_prefix = '/disks/strg16-176/nam/data/html_ja_tables/wiki_jp_tables_full_border_v2/val/'
valid_anno_file1 = '/home2/nam/nam_data/data/mmocr_wikitabnet_ja_full_border_v2_val_64/StructureLabelAddEmptyBbox_val/'
valid = dict(
    type=dataset_type,
...
test_img_prefix = '/disks/strg16-176/nam/data/html_ja_tables/wiki_jp_tables_full_border_v2/test/'
test_anno_file1 = '/home2/nam/nam_data/data/mmocr_wikitabnet_ja_full_border_v2_test/StructureLabelAddEmptyBbox_test/'
test = dict(
    type=dataset_type,
