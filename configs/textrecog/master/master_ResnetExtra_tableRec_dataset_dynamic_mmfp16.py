...
alphabet_file = '/disks/vaskar/exodus/icdar-2021-competition/data/mmocr_pubtabnet_recognition_0726/textline_recognition_alphabet.txt'
...
img_prefix1 = ''
train_anno_file1 = '/disks/vaskar/exodus/icdar-2021-competition/data/mmocr_pubtabnet_recognition_0726/recognition_train_txt/all.txt'
train1 = dict(
    type=dataset_type,
...
test_ann_files = {'table_Rec_val_debug_0': '/disks/vaskar/exodus/icdar-2021-competition/data/mmocr_pubtabnet_recognition_0726/recognition_val_txt/0.txt'}
testset = [dict(
    type=dataset_type,
