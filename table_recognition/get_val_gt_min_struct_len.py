...
data_path = '/home2/nam/pubtabnet/pubtabnet/'
jsonFile = data_path + 'PubTabNet_2.0.0.jsonl'
# smallVal300 = ''
...
with open(jsonFile, 'rb') as f:
    for item in tqdm(json_lines.reader(f)):
        ...
        shutil.copy2(data_path + 'val/' + filename, data_path + 'val_min250/')


gtFile = '/home2/nam/nam_data/pubtabnet/gtVal_struct_min250.json'
