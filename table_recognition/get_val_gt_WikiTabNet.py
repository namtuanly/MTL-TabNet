...
path_dir = '/disks/strg16-176/nam/data/html_ja_tables/wiki_en_tables_borderless/wiki_en_tables_borderless_89/'

jsonFile = path_dir + 'WikiTabNet_en_89_table_test.jsonl'
# smallVal300 = ''
...
with open(jsonFile, 'rb') as f:
    for item in tqdm(json_lines.reader(f)):
        ...
        gtDict[filename] = gtSample

        with open(path_dir + 'test_html/' + filename[:-3] + 'html', 'w') as f_txt:
            f_txt.write(gtToken)


gtFile = path_dir + 'gtWiki_test_full.json'
