...
if __name__ == '__main__':
    ...
    cfg = {
        'structure_master_config': './configs/textrecog/master/table_master_ResnetExtract_Ranger_0705_WikiTabNet_cell150_batch4.py',  # structure
        'structure_master_ckpt': '/home2/nam/nam_data/work_dir/1114_TableMASTER_WikiTabNet_seq500_cell100_batch4/epoch_'
                                 + str(epoch_id) + '.pth',              # structure
        'structure_master_result_folder': '/home2/nam/nam_data/work_dir/1114_TableMASTER_WikiTabNet_seq500_cell100_batch4/structure_realtest_result_epoch_'
                                          + str(epoch_id),         # structure
        'test_folder': '/disks/strg16-176/nam/data/html_ja_tables/wiki_jp_tables_full_border/real_japanese_tables/',                  # structure
