...
class PubtabnetParser(object):
    def __init__(self, jsonl_path, is_toy=True, split='val', is_pse_preLabel=False, chunks_nums=16):
        self.split = split
        self.raw_img_root = '/disks/strg16-176/nam/data/html_ja_tables/wiki_jp_tables_full_border/'
        self.save_root = '/disks/vaskar/nam/data/mmocr_wikitabnet_ja_full_border_' + split + '/'
        ...
        self.dataset_size = 256 if is_toy else float("inf")
...
if __name__ == '__main__':
    ...
    jsonl_path = r'/disks/strg16-176/nam/data/html_ja_tables/wiki_jp_tables_full_border/WikiTabNet_1.0.1_ja_table_' + split + '.jsonl'
