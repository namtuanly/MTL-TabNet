...
class PubtabnetParser(object):
    def __init__(self, jsonl_path, is_toy=True, split='val', is_pse_preLabel=False, chunks_nums=16):
        self.split = split
        self.raw_img_root = '/disks/strg16-176/nam/data/html_ja_tables/wiki_jp_tables_full_border_v3/'
        self.save_root = '/disks/vaskar/nam/data/mmocr_wikitabnet_ja_full_border_v3_' + split + '/'
    ...
    def parse_single_chunk(self, this_chunk, chunks_idx):
        ...
        for item in tqdm(self.data_generator):
            ...
            # check table which don't have any nonempty cell
            cells = item['html']['cells']
            non_empty_cell = 0
            ...
            if non_empty_cell == 0:
                self.cell_content_null += 1
                print('Empty sample:' + str(self.cell_content_null) + ':' + filename)
                continue
...
if __name__ == '__main__':
    ...
    jsonl_path = r'/disks/strg16-176/nam/data/html_ja_tables/wiki_jp_tables_full_border_v3/WikiTabNet_jp_v3_table_' + split + '.jsonl'
