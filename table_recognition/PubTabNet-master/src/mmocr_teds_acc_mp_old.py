...
if __name__ == "__main__":
    ...
    gtJsonFile = '/home2/nam/nam_data/pubtabnet/gtVal_full.json'
    # gtJsonFile = '/disks/vaskar/nam/work_dir/gtVal_cell100.json'

    pubtabnet_dir = '/home2/nam/pubtabnet/pubtabnet/val/'
