...
if __name__ == "__main__":
    ...
    predFile = '/disks/strg16-176/nam/VQAonBD2023/test_20_PubTab_epoch20/'

    fintabnet_dir = '/disks/strg16-176/nam/VQAonBD2023/test_20/'
    ...
    for idx, (file_name, context) in enumerate(predDict.items()):
        ...
        # # visualize bboxes
        visual_pred_bboxes(context['bbox'], file_name, predFile, fintabnet_dir)

        f = open(os.path.join(predFile, file_name.replace('.png', '.txt')), 'w')
