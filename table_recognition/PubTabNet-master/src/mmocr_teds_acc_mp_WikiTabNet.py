...
if __name__ == "__main__":
    ...
    predFile = '/home2/nam/nam_data/work_dir/1114_TableMASTER_WikiTabNet_seq500_cell100_batch4/structure_test_result_epoch_' + str(epoch_id)
    gtJsonFile = '/disks/strg16-176/nam/data/html_ja_tables/wiki_jp_tables/gtWikiTest_full.json'

    pubtabnet_dir = '/disks/strg16-176/nam/data/html_ja_tables/wiki_jp_tables/test/'
