...
class PubtabnetParser(object):
    def __init__(self, jsonl_path, is_toy=True, split='val', is_pse_preLabel=False, chunks_nums=16):
        ...
        self.save_root = '/disks/vaskar/nam/data/mmocr_fintabnet_recognition_0726_' + split + '_64/'
...
if __name__ == '__main__':
    ...
    parser = PubtabnetParser(jsonl_path, is_toy=True, split=split, is_pse_preLabel=False, chunks_nums=nproc)
