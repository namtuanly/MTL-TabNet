...
def searchMerge(tokensList):
    pointer = 0
    mergedTokenList = []
    while tokensList[pointer]!='</table>':
        if tokensList[pointer]=='<td>':
            ...
            pointer += 1
    mergedTokenList.append('</table>')
    return mergedTokenList


jsonFile = '/disks/strg16-176/nam/data/fintabnet/img_tables/FinTabNet_1.0.0_table_test.jsonl'
# smallVal300 = ''
...
gtFile = '/disks/strg16-176/nam/data/fintabnet/img_tables/gtVal_FinTabNet_test.json'
