...
if __name__ == '__main__':
    ...
    parser.add_argument('--tablemaster_config', type=str,
                        default='./configs/textrecog/master/table_master_ResnetExtract_Ranger_WikiTabNet_ja_full_v3_cell100_batch2.py',
                        help='tablemaster config file')
    parser.add_argument('--checkpoint', type=str,
                        default='epoch_17',
                        help='tablemaster checkpoint file')
    parser.add_argument('--out_dir',
                        type=str, default='/home2/nam/nam_data/work_dir/1114_TableMASTER_ja_v3_cell100_batch2/demo_outputs/', help='Dir to save results')
