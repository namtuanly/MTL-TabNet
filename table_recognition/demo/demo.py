...
if __name__ == '__main__':
    ...
    parser.add_argument('--tablemaster_checkpoint', type=str,
                        default='/home2/nam/nam_data/work_dir/1114_TableMASTER_structure_seq500_cell150_batch4/step_12_17/epoch_20.pth',
                        help='tablemaster checkpoint file')
    parser.add_argument('--out_dir',
                        type=str, default='/home2/nam/nam_data/work_dir/1114_TableMASTER_structure_seq500_cell150_batch4/step_12_17/demo_outputs', help='Dir to save results')
