...
class PubtabnetParser(object):
    def __init__(self, jsonl_path, is_toy=True, split='val', is_pse_preLabel=False, chunks_nums=16):
        self.split = split
        self.raw_img_root = '/disks/strg16-176/table_analysis/pubtabnet/pubtabnet/'
        self.save_root = '/home2/nam/nam_data/data/mmocr_pubtabnet_recognition_0726_val32_tagmin250/'
        ...
        self.dataset_size = 32 if is_toy else float("inf")
    ...
    def parse_single_chunk(self, this_chunk, chunks_idx):
        ...
        for item in tqdm(self.data_generator):
            ...
            token_list = item['html']['structure']['tokens']
            # only table that has seq_len larger than 300
            if len(token_list) < 250:
                continue
...
if __name__ == '__main__':
    ...
    jsonl_path = r'/disks/strg16-176/table_analysis/pubtabnet/pubtabnet/PubTabNet_2.0.0.jsonl'
